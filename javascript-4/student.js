...
me = {
    firstName: 'Elijah',
    superHeroName: 'Syntax',
    homeTown: 'Javangeles Scriptulon 5',
    superPowers: ['super speed typing', 'can read any programming launguage', 'never has any errors'],
