...
// Code Here
let filtered = myNumbers.filter((el)=>{
	return el > 100
})
//////////////////PROBLEM 16////////////////////
...
// Code Here
let total = myNumbers.reduce((acc, curr)=>{
	return acc += curr
},0)
//////////////////PROBLEM 17////////////////////
...
// Code Here
let forTheLoveOfGeorge = notGeorge.map(el => {
	return el = 'George'
})
//////////////////PROBLEM 19////////////////////
...
// let enemies = people.filter((el)=>{
// 	return el.friend === false
// });

let enemies = people.filter(function(el){
	return el.friend === false
})
